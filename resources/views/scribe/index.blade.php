...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "https://my-laravel-site.ddev.site";
        var useCsrf = Boolean();
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                    <ul id="tocify-header-introduction-wallet-tracker-api" class="tocify-header">
                <li class="tocify-item level-1" data-unique="introduction-wallet-tracker-api">
                    <a href="#introduction-wallet-tracker-api">Introduction Wallet Tracker API</a>
                </li>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="categories">
                    <a href="#categories">Categories</a>
                                ...
                                <a href="#categories-GETapi-categories">Display a listing of the categories.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="categories-POSTapi-categories">
                                <a href="#categories-POSTapi-categories">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="categories-GETapi-categories--id-">
                                <a href="#categories-GETapi-categories--id-">Display the specified category.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="categories-PUTapi-categories--id-">
                                <a href="#categories-PUTapi-categories--id-">Update the specified category in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="categories-DELETEapi-categories--id-">
                                <a href="#categories-DELETEapi-categories--id-">Remove the specified category from storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="transactions">
                    <a href="#transactions">Transactions</a>
                                ...
                                <a href="#transactions-GETapi-transactions">Display a listing of the transaction with filtering.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="transactions-POSTapi-transactions">
                                <a href="#transactions-POSTapi-transactions">Store a newly created transaction in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="transactions-GETapi-transactions--id-">
                                <a href="#transactions-GETapi-transactions--id-">Display the specified transaction.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="transactions-PUTapi-transactions--id-">
                                <a href="#transactions-PUTapi-transactions--id-">Update the specified transaction in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="transactions-DELETEapi-transactions--id-">
                                <a href="#transactions-DELETEapi-transactions--id-">Remove the specified transaction from storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="wallets">
                    <a href="#wallets">Wallets</a>
                                ...
                                <a href="#wallets-GETapi-wallets">Display a listing of wallets with optional filters.</a>
                            </li>
                                ...
                                <a href="#wallets-GETapi-wallets--id-">Display the specified wallet.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="wallets-PUTapi-wallets--id-">
                                <a href="#wallets-PUTapi-wallets--id-">Update the specified wallet in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="wallets-DELETEapi-wallets--id-">
                                <a href="#wallets-DELETEapi-wallets--id-">Remove the specified wallet from storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<div class="page-wrapper">
    ...
    <div class="content">
        <h1 id="introduction-wallet-tracker-api">Introduction Wallet Tracker API</h1>
<aside>
...
<p>Welcome to the Wallet Tracker API documentation.<br />
This API allows you to manage <strong>financial wallets</strong>, <strong>transactions</strong>, and <strong>categories</strong> in a structured and RESTful way.</p>
<h3 id="features">Features</h3>
<ul>
<li>Create, view, update, and delete wallets</li>
<li>Track income/expense transactions</li>
<li>Organize transactions with categories</li>
<li>Filter results using query parameters</li>
<li>Fully documented with real-time testing (Try it out)</li>
</ul>
<blockquote>
<p>Note: This API currently does <strong>not require authentication</strong>.</p>
</blockquote>
<p>For each endpoint, you’ll find:</p>
<ul>
<li>Example requests and responses</li>
<li>Required parameters</li>
<li>Description of purpose</li>
<li>Live “Try it out” functionality</li>
</ul>
<p>Enjoy using the API — feel free to test all endpoints directly from this documentation!</p>
...
<p>This API is not authenticated.</p>
    ...
    <p>Manage income/expense categories like &quot;Food&quot;, &quot;Salary&quot;, etc.</p>

                                <h2 id="categories-GETapi-categories">Display a listing of the categories.</h2>
...
<div class="bash-example">
    ...
    --get "https://my-laravel-site.ddev.site/api/categories" \
...
<div class="javascript-example">
    ...
    "https://my-laravel-site.ddev.site/api/categories"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="categories-POSTapi-categories">Store a newly created resource in storage.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The name of the category. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Either &quot;income&quot; or &quot;expense&quot;. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional An emoji or CSS icon. Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="categories-GETapi-categories--id-">Display the specified category.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://my-laravel-site.ddev.site/api/categories/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://my-laravel-site.ddev.site/api/categories/16"
);
...
<p>The ID of the category. Example: <code>16</code></p>
                    ...
                    <h2 id="categories-PUTapi-categories--id-">Update the specified category in storage.</h2>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional The category name. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>type</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Either &quot;income&quot; or &quot;expense&quot;. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>icon</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional An icon. Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="categories-DELETEapi-categories--id-">Remove the specified category from storage.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://my-laravel-site.ddev.site/api/user" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://my-laravel-site.ddev.site/api/user"
);
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Manage income and expense transactions for wallets.</p>

                                <h2 id="transactions-GETapi-transactions">Display a listing of the transaction with filtering.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://my-laravel-site.ddev.site/api/transactions?wallet_id=16&amp;category_id=16&amp;type=architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://my-laravel-site.ddev.site/api/transactions"
);
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="wallet_id"                data-endpoint="GETapi-transactions"
               value="16"
               data-component="query">
    <br>
<p>Filter by wallet ID. Example: <code>16</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter by category ID. Example: <code>16</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>type</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter by transaction type (e.g. deposit, withdrawal). Example: <code>architecto</code></p>
            </div>
                </form>

                    <h2 id="transactions-POSTapi-transactions">Store a newly created transaction in storage.</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="wallet_id"                data-endpoint="POSTapi-transactions"
               value="16"
               data-component="body">
    <br>
<p>The wallet this transaction belongs to. Example: <code>16</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>category_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional The category of the transaction. Example: <code>16</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>type</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The transaction type (deposit or withdrawal). Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The amount of the transaction. Example: <code>4326.41688</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Description of the transaction. Example: <code>Eius et animi quos velit et.</code></p>
        </div>
        </form>

                    <h2 id="transactions-GETapi-transactions--id-">Display the specified transaction.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://my-laravel-site.ddev.site/api/transactions/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://my-laravel-site.ddev.site/api/transactions/16"
);
...
<p>The ID of the transaction. Example: <code>16</code></p>
                    ...
                    <h2 id="transactions-PUTapi-transactions--id-">Update the specified transaction in storage.</h2>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="wallet_id"                data-endpoint="PUTapi-transactions--id-"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the wallets table.</p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>category_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>Example: <code>Eius et animi quos velit et.</code></p>
                    ...
                    <h2 id="transactions-DELETEapi-transactions--id-">Remove the specified transaction from storage.</h2>
...
<p>The ID of the transaction. Example: <code>16</code></p>
    ...
    <p>APIs for managing financial wallets (CRUD).
This group includes endpoints to list, create, view, update, and delete wallets.</p>

                                <h2 id="wallets-GETapi-wallets">Display a listing of wallets with optional filters.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://my-laravel-site.ddev.site/api/wallets?type=architecto&amp;currency=architecto&amp;min_balance=4326.41688&amp;max_balance=4326.41688" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://my-laravel-site.ddev.site/api/wallets"
);

const params = {
    "type": "architecto",
    "currency": "architecto",
    "min_balance": "4326.41688",
    "max_balance": "4326.41688",
};
Object.keys(params)
    .forEach(key =&gt; url.searchParams.append(key, params[key]));
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="GETapi-wallets"
               value="architecto"
               data-component="query">
    <br>
<p>Filter by wallet type (e.g. cash, bank, crypto). Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="currency"                data-endpoint="GETapi-wallets"
               value="architecto"
               data-component="query">
    <br>
<p>Filter by currency code (e.g. USD, EUR). Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>min_balance</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="min_balance"                data-endpoint="GETapi-wallets"
               value="4326.41688"
               data-component="query">
    <br>
<p>Minimum wallet balance. Example: <code>4326.41688</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>max_balance</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="max_balance"                data-endpoint="GETapi-wallets"
               value="4326.41688"
               data-component="query">
    <br>
<p>Maximum wallet balance. Example: <code>4326.41688</code></p>
            </div>
                </form>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-wallets"
               value="architecto"
               data-component="body">
    <br>
<p>The wallet name. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The current balance. Example: <code>4326.41688</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>currency</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="currency"                data-endpoint="POSTapi-wallets"
               value="architecto"
               data-component="body">
    <br>
<p>The currency code (e.g. USD). Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>type</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The wallet type (e.g. cash, crypto). Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>category_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="category_id"                data-endpoint="POSTapi-wallets"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the categories table.</p>
                    ...
                    <h2 id="wallets-GETapi-wallets--id-">Display the specified wallet.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://my-laravel-site.ddev.site/api/wallets/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://my-laravel-site.ddev.site/api/wallets/16"
);
...
<p>The ID of the wallet. Example: <code>16</code></p>
                    ...
                    <h2 id="wallets-PUTapi-wallets--id-">Update the specified wallet in storage.</h2>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-wallets--id-"
               value="architecto"
               data-component="body">
    <br>
<p>optional The wallet name. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>balance</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="balance"                data-endpoint="PUTapi-wallets--id-"
               value="4326.41688"
               data-component="body">
    <br>
<p>optional The current balance. Example: <code>4326.41688</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>currency</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="currency"                data-endpoint="PUTapi-wallets--id-"
               value="architecto"
               data-component="body">
    <br>
<p>optional The currency code. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>type</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional The wallet type. Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="wallets-DELETEapi-wallets--id-">Remove the specified wallet from storage.</h2>

<p>
</p>

<p>@urlParam id integer required The ID of the wallet.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "https://my-laravel-site.ddev.site/api/wallets/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the wallet. Example: <code>1</code></p>
            </div>
                    </form>
